    ...
    <section className="create-post-container w-screen h-screen">
      <div className="h-full overflow-y-auto px-4 pt-3">
        ...
        <div className="AI-container rounded-lg shadow-lg px-5 pt-4 mb-4">
          ...
          <div className="py-3">
            <button onClick={savePost} className="btn px-5 text-center bg-purple-600 text-white hover:bg-purple-700 hover:shadow-lg hover:border hover:border-gray-400 mx-auto block mb-3">
              Post Now
            </button>
            <span className="text-white text-center block">Or</span>
            {mediaPre&&<img src={mediaPre} height="200px" width="200px"/>}
            <input type="file" name="file" accept=".jpg,.png,.mp4, .jpeg" className="form-control"  onChange={changeMedia}/>
            <button onClick={()=>uploadImage()} className="btn px-5 text-center bg-purple-600" type="submit">Post</button>
